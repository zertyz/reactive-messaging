...
use crate::types::{ReactiveResponsiveProcessorAssociatedTypes, ReactiveProcessorController, ResponsiveMessages};
...
impl<const CONFIG:     u64,
     ...
     ProcessorUniType: GenericUni<ItemType=RemoteMessages>                                         + Send + Sync                     + 'static,
     SenderChannel:    FullDuplexUniChannel<ItemType=LocalMessages, DerivedItemType=LocalMessages> + Send + Sync>
ResponsiveSocketClient<CONFIG, RemoteMessages, LocalMessages, ProcessorUniType, SenderChannel> {
